...
describe('Test Oi4ApplicationResources', () => {
    ...
    it('should be able to get all sub resources if oi4id not specified', () => {
        ...
        const value01 = {oi4Id:oi4Id01, health: new Health(EDeviceHealth.MAINTENANCE_REQUIRED_4, 50)} as OI4ApplicationResources;
        const value02 = {oi4Id:oi4Id02, health: new Health(EDeviceHealth.CHECK_FUNCTION_2, 75)} as OI4ApplicationResources;
        const value03 = {oi4Id:oi4Id03, health: new Health(EDeviceHealth.NORMAL_0, 100)} as OI4ApplicationResources;
        ...
        const subResources: IterableIterator<IOI4ApplicationResources> = resources.getSubResource() as IterableIterator<IOI4ApplicationResources>;

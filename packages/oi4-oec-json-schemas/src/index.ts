...
import topicPathSchemaJson from './schemas/constants/topicPath.schema.json';
import serviceTypeSchemaJson from './schemas/constants/serviceType.schema.json';
...
// DataTypes
import byteSchemaJson from './schemas/dataTypes/byte.schema.json';
import int8SchemaJson from './schemas/dataTypes/int8.schema.json';
import int16SchemaJson from './schemas/dataTypes/int16.schema.json';
import int32SchemaJson from './schemas/dataTypes/int32.schema.json';
